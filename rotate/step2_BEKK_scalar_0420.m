...
[theta_hat, log_likelihood] = fmincon(@(theta)scalar_likelihood(theta,lret,RK), theta, [],[],[],[],LB,UB,[],options); % constraint on rbekk
warning('on') %#ok<*WNON>
...
[L,~, logH] = scalar_likelihood(theta_hat,  lret, RK);
L = -L;
