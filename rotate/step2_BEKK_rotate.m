...
tic
[theta_hat, log_likelihood] = fmincon(@(theta)rbekk_likelihood_rotate(theta,e,RRK), theta, [],[],[],[],LB,UB,@constraint_rotate,options); % constraint on rbekk
warning('off') %#ok<*WNON>
toc
...
[L,m , RH] = rbekk_likelihood_rotate(theta_hat,e,RRK);
L = -L;
